# Source
Theses scripts are copied from https://github.com/pytorch/vision/tree/master/references/segmentation
Minor modifications have been made to the files to customize the training process.
